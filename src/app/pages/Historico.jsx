      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-foreground">Histórico de Reservas</h1>
          </div>
          <p className="text-muted-foreground">Todas as suas reservas e retiradas</p>
        </div>
        ...
        <Card className="p-6">
          <div className="space-y-4">
            {reservationHistory.map((reservation) => (
              <div
                key={reservation.id}
                className="flex items-center gap-4 p-4 border border-border rounded-lg hover:shadow-md hover:bg-accent transition-all"
              >
                <img
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Data de retirada: {new Date(reservation.pickupDate).toLocaleDateString('pt-BR')}
                  </p>
                </div>
                <div>
                  <span
